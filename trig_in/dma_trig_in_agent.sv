...
// Trigger-IN (requester) agent: sequencer + driver + monitor (+ coverage).
// Fetches its typed virtual interface (dma_trig_in_if) and pushes it down to
...
class dma_trig_in_agent extends uvm_agent;
  ...
  function void build_phase(uvm_phase phase);
    ...
    // Hand the typed vif + cfg to children.
    uvm_config_db#(virtual dma_trig_in_if)::set(this, "drv", "vif", vif);
    uvm_config_db#(virtual dma_trig_in_if)::set(this, "mon", "vif", vif);
