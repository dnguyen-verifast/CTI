...
//
//   dma_trig_in_dmac  : drives trig_in_ack / trig_in_ack_type (the DMAC reply)
...
//   dma_trig_out_dmac : periodically drives trig_out_req (the DMAC emitting a
//                       trigger) and waits for the VIP's ack
//
